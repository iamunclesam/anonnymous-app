        ...
        <div>
            ...
            <section className="">
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
                    ...
                    <div className="w-full rounded-lg shadow dark:border border border-gray-700 md:mt-0 sm:max-w-md xl:p-0 md:dark:bg-gray-800 md:dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                                Sign in to your account
                            </h1>
                            <form onSubmit={authLogin} className="space-y-4 md:space-y-6" action="#">
                                <div>
